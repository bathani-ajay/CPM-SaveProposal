...
<!-- @generated mapFile="com/tagic/gc/cpm/xslt/CPMRequestMap.map" md5sum="ed7b0572243b7ea506f4e31d01a86a5e" version="8.0.501" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
          ...
          <cpmGCRequest>
            ...
            <inputXML>
                ...
                <risks>
                  <propRisksCoverDetailsCol>
                    ...
                    <value>
                      ...
                      <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:coverDetails" mode="localCoverDetailsToRisksCoverDetails_1030938449">
                      </xsl:apply-templates>
                    </value>
              ...
              <PropGeneralProposal_ClauseDetails_Col>
                ...
                <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:clauseDetails" mode="localClauseDetailsToGeneralProposalClauseDetails_388139443">
                </xsl:apply-templates>
              </PropGeneralProposal_ClauseDetails_Col>
              <PropGeneralProposal_FinancierDetails_Col>
                ...
                <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:financierDetails" mode="localFinancierDetailsToGeneralProposalFinancierDetails_84773172">
                </xsl:apply-templates>
              </PropGeneralProposal_FinancierDetails_Col>
              ...
              <Root>
                ...
                <OtherDetailsGrid>
                  ...
                  <RiskLocationDetails>
                    ...
                    <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:riskLocationDetails" mode="localRiskLocationDetailsToRiskLocationDetails_884483239">
                    </xsl:apply-templates>
                  </RiskLocationDetails>
                  <Deductibles>
                    <!-- a simple mapping with no associated source:  to "Name"(string) -->
                    ...
                    <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:deductibles" mode="localDeductiblesToDeductibles_1712236022">
                    </xsl:apply-templates>
                  </Deductibles>
                  <ClauseWordings>
                    <!-- a simple mapping with no associated source:  to "Name"(string) -->
                    ...
                    <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:clauseWording" mode="localClauseWordingToClauseWordings_281600001">
                    </xsl:apply-templates>
                  </ClauseWordings>
                  <AdditionalInsuredDetail>
                    ...
                    <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:additionalInsuredDetails" mode="localAdditionalInsuredDetailsToAdditionalInsuredDetail_251759261">
                    </xsl:apply-templates>
                  </AdditionalInsuredDetail>
                  <WarrantyDetails>
                    <!-- a simple mapping with no associated source:  to "Name"(string) -->
                    ...
                    <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:warrantyDetails" mode="localWarrantyDetailsToWarrantyDetails_1199491723">
                    </xsl:apply-templates>
                  </WarrantyDetails>
                  <OtherDetails>
                    <!-- a simple mapping with no associated source:  to "Name"(string) -->
                    ...
                    <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:otherDetails" mode="localOtherDetailsToOtherDetails_118315333">
                    </xsl:apply-templates>
                  </OtherDetails>
                  <!-- variables for custom code -->
                  ...
                  <xsl:choose>
                    <xsl:when test="fn:boolean($floaterCover) and $floaterCover != &apos;&apos; and $floaterCover != &apos;Yes&apos;">
                      <AddonCoversClauses>
                        ...
                        <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:addOnCovers" mode="localAddOnCoversToAddonCoversClauses_891634162">
                        </xsl:apply-templates>
                      </AddonCoversClauses>
                      <CPMGrid>
                        <!-- a simple mapping with no associated source:  to "Name"(string) -->
                        ...
                        <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:cpmGrid" mode="localCpmGridToCPMGrid_1698069676">
                        </xsl:apply-templates>
                      </CPMGrid>
                    </xsl:when>
                    <xsl:otherwise>
                      <CPMFloaterPolicyAddonCoversClausesGrid>
                        ...
                        <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:addOnCovers" mode="localAddOnCoversToCPMFloaterPolicyAddonCoversClausesGrid_47508547">
                        </xsl:apply-templates>
                      </CPMFloaterPolicyAddonCoversClausesGrid>
                      <CPMFloaterPolicyGrid>
                        ...
                        <xsl:apply-templates select="body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:cpmGrid" mode="localCpmGridToCPMFloaterPolicyGrid_966556682">
                        </xsl:apply-templates>
                      </CPMFloaterPolicyGrid>
                    </xsl:otherwise>
                  </xsl:choose>
      ...
      <out2:cpmGCProposalSync>
        <cpmGCRequest>
          ...
          <inputXML>
            <PropRisksCol>
              <risks>
                <propRisksCoverDetailsCol>
                  ...
                  <value>
                    <!-- a for-each transform: "in2:coverDetails"(paceCPMCoverDetailsBO) to "risksCoverDetails"(RiskCoverDetailsBO) -->
                    <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:coverDetails" mode="localCoverDetailsToRisksCoverDetails_1030938449">
                    </xsl:apply-templates>
                  </value>
                  <!-- a simple mapping with no associated source:  to "nil"(boolean) -->
                  <xsl:element name="nil">
            ...
            <PropGeneralProposal_ClauseDetails_Col>
              <!-- a for-each transform: "in2:clauseDetails"(paceCPMClausesBO) to "generalProposalClauseDetails"(clauseDetailsBO) -->
              <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:clauseDetails" mode="localClauseDetailsToGeneralProposalClauseDetails_388139443">
              </xsl:apply-templates>
            </PropGeneralProposal_ClauseDetails_Col>
            <PropGeneralProposal_FinancierDetails_Col>
              <!-- a for-each transform: "in2:financierDetails"(paceCPMFinancierDetailsBO) to "generalProposalFinancierDetails"(financierDetailsBO) -->
              <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:financierDetails" mode="localFinancierDetailsToGeneralProposalFinancierDetails_84773172">
              </xsl:apply-templates>
            </PropGeneralProposal_FinancierDetails_Col>
            <!-- a simple mapping with no associated source:  to "ProductType"(string) -->
            <xsl:element name="ProductType">
            ...
            <Root>
              ...
              <OtherDetailsGrid>
                ...
                <RiskLocationDetails>
                  ...
                  <!-- a for-each transform: "in2:riskLocationDetails"(paceCPMRiskDetailsBO) to "RiskLocationDetails"(OtherDetailsRiskLocationBO) -->
                  <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:riskLocationDetails" mode="localRiskLocationDetailsToRiskLocationDetails_884483239">
                  </xsl:apply-templates>
                </RiskLocationDetails>
                <Deductibles>
                  <!-- a simple mapping with no associated source:  to "Name"(string) -->
                  ...
                  <!-- a for-each transform: "in2:deductibles"(paceCPMDeductibles) to "Deductibles"(deductibleBO) -->
                  <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:deductibles" mode="localDeductiblesToDeductibles_1712236022">
                  </xsl:apply-templates>
                </Deductibles>
                <ClauseWordings>
                  <!-- a simple mapping with no associated source:  to "Name"(string) -->
                  ...
                  <!-- a for-each transform: "in2:clauseWording"(ClauseDetailsBO) to "ClauseWordings"(clauseWordingsBO) -->
                  <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:clauseWording" mode="localClauseWordingToClauseWordings_281600001">
                  </xsl:apply-templates>
                </ClauseWordings>
                <AdditionalInsuredDetail>
                  <!-- a simple mapping with no associated source:  to "Name"(string) -->
                  ...
                  <!-- a for-each transform: "in2:additionalInsuredDetails"(NameValueBO) to "AdditionalInsuredDetail"(additionalInsuredBO) -->
                  <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:additionalInsuredDetails" mode="localAdditionalInsuredDetailsToAdditionalInsuredDetail_251759261">
                  </xsl:apply-templates>
                </AdditionalInsuredDetail>
                <WarrantyDetails>
                  <!-- a simple mapping with no associated source:  to "Name"(string) -->
                  ...
                  <!-- a for-each transform: "in2:warrantyDetails"(NameValueBO) to "WarrantyDetails"(warrantyDetailsBO) -->
                  <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:warrantyDetails" mode="localWarrantyDetailsToWarrantyDetails_1199491723">
                  </xsl:apply-templates>
                </WarrantyDetails>
                <OtherDetails>
                  <!-- a simple mapping with no associated source:  to "Name"(string) -->
                  ...
                  <!-- a for-each transform: "in2:otherDetails"(paceCPMOthersDetailBO) to "OtherDetails"(otherDetailsBO) -->
                  <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:otherDetails" mode="localOtherDetailsToOtherDetails_118315333">
                  </xsl:apply-templates>
                </OtherDetails>
                <!-- variables for custom code -->
                ...
                <xsl:choose>
                  <xsl:when test="fn:boolean($floaterCover) and $floaterCover != &apos;&apos; and $floaterCover != &apos;Yes&apos;">
                    <AddonCoversClauses>
                      ...
                      <!-- a for-each transform: "in2:addOnCovers"(paceCPMCovers) to "AddonCoversClauses"(addOnCoverBO) -->
                      <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:addOnCovers" mode="localAddOnCoversToAddonCoversClauses_891634162">
                      </xsl:apply-templates>
                    </AddonCoversClauses>
                    <CPMGrid>
                      <!-- a simple mapping with no associated source:  to "Name"(string) -->
                      ...
                      <!-- a for-each transform: "in2:cpmGrid"(paceCPMCovers) to "CPMGrid"(cpmGridBO) -->
                      <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:cpmGrid" mode="localCpmGridToCPMGrid_1698069676">
                      </xsl:apply-templates>
                    </CPMGrid>
                  </xsl:when>
                  <xsl:otherwise>
                    <CPMFloaterPolicyAddonCoversClausesGrid>
                      ...
                      <!-- a for-each transform: "in2:addOnCovers"(paceCPMCovers) to "CPMFloaterPolicyAddonCoversClausesGrid"(addOnCoverBO) -->
                      <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:addOnCovers" mode="localAddOnCoversToCPMFloaterPolicyAddonCoversClausesGrid_47508547">
                      </xsl:apply-templates>
                    </CPMFloaterPolicyAddonCoversClausesGrid>
                    <CPMFloaterPolicyGrid>
                      <!-- a simple mapping with no associated source:  to "Name"(string) -->
                      ...
                      <!-- a for-each transform: "in2:cpmGrid"(paceCPMCovers) to "CPMFloaterPolicyGrid"(floaterPolicyGridBO) -->
                      <xsl:apply-templates select="$smo/body/in3:paceCPMGCProposalSync/paceCPMRequest/in2:cpmGrid" mode="localCpmGridToCPMFloaterPolicyGrid_966556682">
                      </xsl:apply-templates>
                    </CPMFloaterPolicyGrid>
                  </xsl:otherwise>
                </xsl:choose>
  ...
  <xsl:template match="in2:coverDetails"  mode="localCoverDetailsToRisksCoverDetails_1030938449">
    <risksCoverDetails>
  ...
  <xsl:template match="in2:clauseDetails"  mode="localClauseDetailsToGeneralProposalClauseDetails_388139443">
  ...
  <xsl:template match="in2:financierDetails"  mode="localFinancierDetailsToGeneralProposalFinancierDetails_84773172">
  ...
  <xsl:template match="in2:riskLocationDetails"  mode="localRiskLocationDetailsToRiskLocationDetails_884483239">
    <RiskLocationDetails>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:clauseWording"  mode="localClauseWordingToClauseWordings_281600001">
    <ClauseWordings>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:warrantyDetails"  mode="localWarrantyDetailsToWarrantyDetails_1199491723">
    <WarrantyDetails>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:additionalInsuredDetails"  mode="localAdditionalInsuredDetailsToAdditionalInsuredDetail_251759261">
    <AdditionalInsuredDetail>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:otherDetails"  mode="localOtherDetailsToOtherDetails_118315333">
    <OtherDetails>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
      ...
      <TotalofSI>
        ...
        <xsl:choose>
          <xsl:when test="normalize-space(string(in2:totalSI))">
            <xsl:element name="Value">
              <!-- variables for custom code -->
              <xsl:variable name="totalSI" select="in2:totalSI"/>
              <xsl:value-of select="MapUtils:doubleToString($totalSI, '')"/>
            </xsl:element>
          </xsl:when>
          <xsl:otherwise>
            <xsl:element name="Value">
  ...
  <xsl:template match="in2:deductibles"  mode="localDeductiblesToDeductibles_1712236022">
    <Deductibles>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:addOnCovers"  mode="localAddOnCoversToAddonCoversClauses_891634162">
    <AddonCoversClauses>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:cpmGrid"  mode="localCpmGridToCPMGrid_1698069676">
    <CPMGrid>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:addOnCovers"  mode="localAddOnCoversToCPMFloaterPolicyAddonCoversClausesGrid_47508547">
    <CPMFloaterPolicyAddonCoversClausesGrid>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
  ...
  <xsl:template match="in2:cpmGrid"  mode="localCpmGridToCPMFloaterPolicyGrid_966556682">
    <CPMFloaterPolicyGrid>
      <!-- a simple mapping with no associated source:  to "Type"(string) -->
      <Type>
        <xsl:text>GroupData</xsl:text>
